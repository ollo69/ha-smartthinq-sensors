...
AC_SENSORS: tuple[ThinQSensorEntityDescription, ...] = (
    ...
    # Second Circuit Sensors
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.SECOND_CIRCUIT_ONOFF,
        name="Second circuit on/off",
        icon="mdi:electric-switch",
        entity_registry_enabled_default=False,
    ),
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.SECOND_CIRCUIT_OPERATION,
        name="Second circuit operation",
        icon="mdi:power-cycle",
        entity_registry_enabled_default=False,
    ),
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.SECOND_CIRCUIT_CURRENT_TEMP,
        name="Second circuit current temperature",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
        unit_fn=lambda x: x.temp_unit,
    ),
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.SECOND_CIRCUIT_TARGET_TEMP,
        name="Second circuit target temperature",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
        unit_fn=lambda x: x.temp_unit,
        entity_registry_enabled_default=False,
    ...
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.SECOND_CIRCUIT_WATER_OUT_TEMP,
        name="Second circuit out water temperature",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
        unit_fn=lambda x: x.temp_unit,
    ),
    # ESS (Energy Storage System) Sensors
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.ESS_BATTERY_REMAIN,
        name="ESS battery remaining",
        icon="mdi:battery",
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=PERCENTAGE,
        entity_registry_enabled_default=False,
    ...
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.ESS_BATTERY_POWER,
    ...
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.ESS_SOLAR_POWER,
        name="ESS solar power",
    ...
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.ESS_GRID_POWER,
        name="ESS grid power",
    ...
    ThinQSensorEntityDescription(
        key=AirConditionerFeatures.ESS_CONSUME_POWER,
        name="ESS consumed power",
