...
from .device import STATE_OPTIONITEM_OFF, STATE_OPTIONITEM_UNKNOWN
...
DRYERSTATES = {
    STATE_OPTIONITEM_UNKNOWN: STATE_DRYER.UNKNOWN,
...
DRYERDRYLEVELS = {
    STATE_OPTIONITEM_UNKNOWN: STATE_DRYER_DRYLEVEL.UNKNOWN,
    ...
    "@WM_TITAN2_OPTION_DRY_30_W": STATE_DRYER_DRYLEVEL.TEMP_30,
    "@WM_TITAN2_OPTION_DRY_60_W": STATE_DRYER_DRYLEVEL.TEMP_60,
    "@WM_TITAN2_OPTION_DRY_90_W": STATE_DRYER_DRYLEVEL.TEMP_90,
    "@WM_TITAN2_OPTION_DRY_120_W": STATE_DRYER_DRYLEVEL.TEMP_120,
    "@WM_TITAN2_OPTION_DRY_150_W": STATE_DRYER_DRYLEVEL.TEMP_150,
...
DRYERTEMPS = {
    STATE_OPTIONITEM_UNKNOWN: STATE_DRYER_TEMP.UNKNOWN,
...
DRYERERRORS = {
    "OFF": STATE_DRYER_ERROR.OFF,
    "NO_ERROR": STATE_DRYER_ERROR.NO_ERROR,
