...
class RangeDevice(Device):
    ...
    def reset_status(self) -> RangeStatus:
...
class RangeStatus(DeviceStatus):
    ...
    def __init__(
        self, device: RangeDevice, data: dict[str, Any] | None = None
    ) -> None:
        """Initialize device status."""
        super().__init__(device, data)
        self._oven_temp_unit: TemperatureUnit | StateOptions | None = None
        self._oven_target_temps: list[int | None] | None = None

    def _get_target_temps(self) -> None:
    ...
    def _get_oven_lower_target_temp(self) -> int | None:
    ...
    def _get_oven_upper_target_temp(self) -> int | None:
    ...
    def _get_oven_temp_unit(self) -> TemperatureUnit | StateOptions:
    ...
    def _get_bit_target_temp(self, key: str) -> int | None:
    ...
    @property
    def cooktop_left_front_state(self) -> str | StateOptions | None:
    ...
    @property
    def cooktop_left_rear_state(self) -> str | StateOptions | None:
    ...
    @property
    def cooktop_center_state(self) -> str | StateOptions | None:
    ...
    @property
    def cooktop_right_front_state(self) -> str | StateOptions | None:
    ...
    @property
    def cooktop_right_rear_state(self) -> str | StateOptions | None:
    ...
    @property
    def oven_lower_state(self) -> str | StateOptions | None:
    ...
    @property
    def oven_lower_mode(self) -> str | StateOptions | None:
    ...
    @property
    def oven_upper_state(self) -> str | StateOptions | None:
    ...
    @property
    def oven_upper_mode(self) -> str | StateOptions | None:
    ...
    @property
    def oven_lower_target_temp(self) -> int | None:
        """Return oven lower target temperature."""
        self._get_target_temps()
        if self._oven_target_temps is None:
            return None
        return self._oven_target_temps[0]

    @property
    def oven_upper_target_temp(self) -> int | None:
        """Return oven upper target temperature."""
        self._get_target_temps()
        if self._oven_target_temps is None:
            return None
    ...
    @property
    def oven_lower_current_temp(self) -> str | None:
        ...
        return self._update_feature(
            RangeFeatures.OVEN_LOWER_CURRENT_TEMP,
    ...
    @property
    def oven_upper_current_temp(self) -> str | None:
        ...
        if not status:  # 0 means not available
            status = None
        return self._update_feature(
            RangeFeatures.OVEN_UPPER_CURRENT_TEMP,
            None if status is None else str(status),
            False,
            allow_none=True,
        )
